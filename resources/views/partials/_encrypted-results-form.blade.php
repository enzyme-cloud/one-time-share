            ...
            <div class="Layout__row-quick Layout__column--text-center">
                <div class="Layout__column-quick">
                    <div class="Form">
                        ...
                        <input id="js-encrypted-data-url-short" type="text" class="Form__input">
                    </div>
                </div>
            </div>
            <div class="Layout__row-quick Layout__column--text-center">
                <div class="Layout__column-quick">
                    <div class="Form">
                        ...
                        <input id="js-encrypted-data-url" type="text" class="Form__input">
                    </div>
                </div>
            </div>
            <div class="Layout__row-quick Layout__column--text-center">
                <div class="Layout__column-quick">
                    <div class="Form">
                        ...
                        <input id="js-encrypted-data-password" type="text" class="Form__input">
                    </div>
                </div>
            </div>
            <div class="Layout__row-quick Layout__column--text-center">
                ...
                <div id="js-pre-signed-url-box" class="Layout__row Layout__row--bottoms Layout__column--text-center util-hidden">
                    <div class="Layout__column-quick Layout__column--xs-12">
                        <div class="Form">
                            ...
                            <input id="js-pre-signed-url" type="text" class="Form__input">
                        </div>
                    </div>
                    <div class="Layout__column-quick Layout__column--xs-12">
